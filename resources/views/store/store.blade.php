                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="http://localhost:8000/checkout"><i class="fa fa-crosshairs"></i> Checkout</a>
                            </li>
                            <li><a href="http://localhost:8000/cart"><i class="fa fa-shopping-cart"></i> Carrinho</a>
                            </li>
